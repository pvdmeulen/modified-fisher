...
[![Codecov test coverage](https://codecov.io/gh/pvdmeulen/modifiedfisher/graph/badge.svg)](https://app.codecov.io/gh/pvdmeulen/modifiedfisher)
<!-- badges: end -->
...
```{r print_data, echo = TRUE, eval = TRUE}
